...
const Parametres = () => {
  ...
  const handleSelectFolder = async () => {
    try {
      const response = await fetch('http://localhost:3001/api/dialog/select-folder', {
        method: 'POST'
      });
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              ...
              L'application surveillera ce répertoire pour détecter automatiquement les nouveaux fichiers.
            </p>
